...
ModTestLeft:
	...
	IN     Dist0
	ADD		LeftDigDist
	JPOS  ModTestLeft ; nothing there
	CALL   ModSendCoordsLeft ; something there; send coordinates
	LOADI  1
	STORE  LeftFlag    ; record that this sensor was tripped
...
ModTestRight:
	...
	IN     Dist5
	ADD		RightDigDist
	JPOS  ModTestRight ; nothing there
	CALL   ModSendCoordsRight ; something there; send coordinates
	LOADI  1
	STORE  RightFlag    ; record that this sensor was tripped
...
LeftFlag:  DW 0
RightFlag: DW 0
LeftDetectDist: DW 3 	;change these
RightDetectDist: DW 0 	;change these
LeftDigCount: DW 0
LeftDigDist: DW 0
RightDigCount: DW 0
RightDigDist: DW 0

StopLoopCount: DW	100
